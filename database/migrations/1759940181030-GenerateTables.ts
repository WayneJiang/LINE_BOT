...
export class GenerateTables1759940181030 implements MigrationInterface {
    name = 'GenerateTables1759940181030'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."Coach_coachtype_enum" AS ENUM('Founder', 'Partner', 'Team')`);
        await queryRunner.query(`CREATE TABLE "Coach" ("id" SERIAL NOT NULL, "socialId" character varying NOT NULL DEFAULT 'Ud519e05aed38a9bf1820a30313615cfb', "name" character varying NOT NULL, "coachType" "public"."Coach_coachtype_enum" NOT NULL DEFAULT 'Founder', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "deletedDate" TIMESTAMP, CONSTRAINT "unique_coach" UNIQUE ("socialId"), CONSTRAINT "PK_bf604e12d74b449fc85d6391b4f" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."Coach_coachtype_enum"`);
