...
export class CreateTables1747816333695 implements MigrationInterface {
    name = 'CreateTables1747816333695'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "TrainingPlan" ("id" SERIAL NOT NULL, "planStartedAt" TIMESTAMP NOT NULL DEFAULT 'infinity'::timestamp, "planEndedAt" TIMESTAMP NOT NULL DEFAULT 'infinity'::timestamp, "planType" "public"."TrainingPlan_plantype_enum" NOT NULL DEFAULT 'none', "planQuota" integer NOT NULL DEFAULT '0', "usedQuota" integer NOT NULL DEFAULT '0', "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "deletedDate" TIMESTAMP, "trainee" integer, "coach_training_plan" integer, "editor_training_plan" integer, CONSTRAINT "PK_1510080e8ad0ad4f4815aa9c793" PRIMARY KEY ("id"))`);
