...
var LineController = /** @class */ (function () {
    function LineController(lineService) {
        this.lineService = lineService;
    }
    LineController.prototype.handleWebhook = function (body) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        event = _a[_i];
                        if (!(event.type == 'message' && event.message.type == 'text')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.lineService.handleTextMessage(event)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
                        if (!(event.type == 'postback')) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.lineService.handlePostBack(event)];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5:
